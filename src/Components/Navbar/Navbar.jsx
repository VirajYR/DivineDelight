      ...
      <div className="Navbar">
        ...
        <div className="menuBar">
          <ul className="menu">
            ...
            <li onClick={() => setMenu("men")}><Link style={{ textDecoration: 'none' }} to="/men">10 ML</Link>{menu === "men" ? <hr /> : <></>}</li>
            <li onClick={() => setMenu("women")}><Link style={{ textDecoration: 'none' }} to="/women">30 ML</Link>{menu === "women" ? <hr /> : <></>}</li>
            <li onClick={() => setMenu("kids")}><Link style={{ textDecoration: 'none' }} to="/kids">100 ML</Link>{menu === "kids" ? <hr /> : <></>}</li>
          </ul>
        </div>
